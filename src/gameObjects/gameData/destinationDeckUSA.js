const DESTINATIONCARDS = [
  ...
  {	from:	'Sault Ste. Marie	',	to:	'Oklahoma City	',	points:	9	},
  ...
  {	from:	'Kansas City	',	to:	'Houston',	points:	5	},
  {	from:	'Seattle',	to:	'Los Angeles	',	points:	9	},
  ...
  {	from:	'Helena',	to:	'Los Angeles	',	points:	8	},
  ...
  {	from:	'Duluth',	to:	'El Paso	',	points:	10	},
  {	from:	'Winnipeg',	to:	'Houston',	points:	12	},
]

module.exports = DESTINATIONCARDS;